...
<nav class="navbar" style="background:rgba(10,10,15,.98);">
  <div class="navbar-inner">
    <a href="index.php" class="navbar-logo"><div class="logo-icon">&#127915;</div><span class="brand">Sur<em>tea</em>dos</span></a>
...
<div class="result-page">
  <div class="result-card">
    ...
    <?php if ($isPaid): ?>
      ...
      <h1>¡Pago exitoso!</h1>
      <p>Tu compra fue procesada correctamente. Guarda los códigos de tus imágenes.</p>
      ...
      <div style="background:var(--bg-base); border-radius:1rem; padding:1.5rem; margin-bottom:1.5rem;">
        ...
        <p style="font-weight:700; margin-top:1rem; margin-bottom:.25rem; font-size:.95rem;">Total de imágenes asignadas: <?= count($allNums) ?></p>
      </div>
    ...
    <?php elseif ($isPending): ?>
      ...
      <p style="font-size:.82rem;">Si el pago fue aprobado, tus imágenes aparecerán aquí en breve.</p>
